...
package com.example.coinapp.crypto.presentation.coin_detail
...
import com.example.coinapp.crypto.presentation.coin_detail.components.InfoCard
import com.example.coinapp.crypto.presentation.coin_list.CoinListAction
import com.example.coinapp.crypto.presentation.coin_list.CoinListState
import com.example.coinapp.crypto.presentation.coin_list.components.previewCoin
import com.example.coinapp.crypto.presentation.models.toDisplayableNumber
import com.example.coinapp.ui.theme.CoinAppTheme
import com.example.coinapp.ui.theme.greenBackground
    ...
    if (state.isLoading) {
        ...
        Column(
            ...
            AnimatedVisibility(
                ...
                var totalChartWidt by remember {
                    mutableFloatStateOf(0f)
                }
                val amountOfVisibleDataPoint = if (labelWidth > 0f) {
                    ((totalChartWidt - 2.5 * labelWidth) / labelWidth).toInt()
                } else {
                    0
                }
